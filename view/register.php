                    ...
                    <div class="row row-space">
                        <div class="col-2">
                            <div class="input-group">
                                ...
                                <input class="input--style-4" type="text" name="userInputFirstname" required>
                            </div>
                        </div>
                        <div class="col-2">
                            <div class="input-group">
                                <label class="label">last name</label>
                                <input class="input--style-4" type="text" name="userInputLastname" required>
                            </div>
                        </div>
                    </div>
                    <div class="row row-space">
                        <div class="col-2">
                            <div class="input-group">
                                ...
                                <input class="input--style-4" type="text" name="userInputUsername" required>
                            </div>
                        </div>
                        <div class="col-2">
                            <div class="input-group">
                                <label class="label">Email</label>
                                <input class="input--style-4" type="email" name="userInputEmail" required>
                            </div>
                        </div>
                    </div>
                    <div class="row row-space">
                        <div class="col-2">
                            <div class="input-group">
                                ...
                                <input class="input--style-4" type="password" name="userInputPassword" required>
                            </div>
                        </div>
                        <div class="col-2">
                            <div class="input-group">
                                <label class="label">password verify</label>
                                <input class="input--style-4" type="password" name="userInputPasswordVerify" required>
                            </div>
                        </div>
                    </div>
                    <div class="row row-space">
                        ...
                        <div class="col-2">
                            <div class="input-group">
                                ...
                                <input class="input--style-4" type="text" name="userInputLocality" required>
                            </div>
                        </div>
                    </div>
                    <div class="row row-space">
                        ...
                        <div class="col-2">
                            <div class="input-group">
                                ...
                                <input class="input--style-4" type="text" name="userInputStreet" required>
                            </div>
                        </div>
                    </div>
                    <div class="p-t-15">
